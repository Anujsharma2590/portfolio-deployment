        ...
        <div className="parallax">
            ...
            <div className="git-cont row">
                <div className="col-12 col-sm-6 half">
                    <form action={contact.contactUrl ? contact.contactUrl : "https://formspree.io/f/xeqnjnkq"} method= "POST" >
                ...
                <div className="inline-block">
                    ...
                    {social.resume && <a title="Download Resume" href={social.resume} rel="noopener noreferrer" target="_blank" download><i className="fas fa-download"></i></a>}
                </div>
                </div>
            </div>
            </div>
