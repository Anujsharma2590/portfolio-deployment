...
const Header = () => {
    ...
    return (
        <div>
            ...
            <p className="line-1 anim-typewriter">full stack web developer... </p>
            ...
            <img id="not-dark" onClick={scrollTo} alt="Contact Me" title="Contact Me" className="gtp" src="https://aanuj.netlify.app/static/media/myimage.f2581a33.png"></img>
        </div>
    )
